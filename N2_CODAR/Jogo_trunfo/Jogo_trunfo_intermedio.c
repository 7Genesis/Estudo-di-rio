...
int main() {
    ...
    media1 = (float)(Populacao1 + Area1) /2;
    printf("A Densidade1 é: %2.f\n", media1);
    
    Capita1 = (float)(PIB1 + Populacao1) /2;
    printf("PIB per Capita1 é: %2.f\n", Capita1);
    ...
    printf("A Densidade2 é: %2.f\n", media2);


    Capita2 = (float)(PIB2 + Populacao2) /2;
    printf("PIB per Capita2 é: %2.f\n", Capita2);
